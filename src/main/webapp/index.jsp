...
<head>
    ...
    <title>Iniciar Sesión - AURA Studio</title>
    ...
    <div class="split-container">
        ...
        <div class="split-image-panel">
            ...
            <div class="split-image-content">
                ...
                <p class="brand-subtitle">Studio &amp; Collection</p>
            </div>
        </div>
            ...
            <div class="form-wrapper">
                <div class="login-card <%= (errorMsg != null) ? "shake" : "" %>">
                    <div class="form-header">
                        <h2 class="form-title">Ingreso al Portal</h2>
                        <p class="form-subtitle">Por favor, introduce tus datos para continuar.</p>
                    </div>
